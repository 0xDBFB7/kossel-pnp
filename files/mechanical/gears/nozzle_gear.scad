...
Center_Hole_Diameter= 7.6	;//[3.3:for 3.17mm motor shaft,5.1:for 5mm motor shaft]
		...
		difference(){	
            ...
            translate ([0,0,thickness+(grub_diam/2)+ grub_extra_h]) 
                rotate ([0,90,0]) cylinder (h=hub_diameter + 2,r=grub_diam/2,$fn=64);
                 ...
                 translate ([-7,0,thickness+(grub_diam/2)+ grub_extra_h]) 
                rotate ([0,90,0]) cylinder (h=hub_diameter + 2,r=grub_diam/2,$fn=64);
